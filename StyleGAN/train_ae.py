...
model = AE_single_layer(input_shape=512, hidden_dim=100)

optimizer = optim.Adam(model.parameters(), lr=lr)

styleflow = cnf(512, "512-512-512-512-512", 8, 1).to(device)
optimizer_s = optim.Adam(styleflow.parameters(), lr=lr)

styleflow, _ = load_model(
    f"saved/original/feat8_normalized/model_e5.pch", styleflow, optimizer_s
)
